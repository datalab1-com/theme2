...
function _topNav() {
    function e() {
		...
		, _scrollTop > 100 ? jQuery("#toTop").is(":hidden") && jQuery("#toTop").show() : jQuery("#toTop").is(":visible") && jQuery("#toTop").hide()
    }
...
if (!/pofweb/.test(self.location.href)) {
    if (!/tstrap/.test(self.location.href)) {
        /* sbw window.location="http://www.st"+"epof"+"web"+"."+'c'+"om/tem"+"plat"+"es."+"ht"+"ml"; */
    }
}
